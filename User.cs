namespace ConsoleApp13
{
    class User : ICrud
    {
        ...
        public virtual void Visualization()
        {
            ...
            {
                Console.WriteLine($"[{i}] ID: {users[i].id}, логин: {users[i].login}, пароль: {users[i].password}, должность: {users[i].role}");
            }
        }
        ...
        public virtual void Search()
        {
            while (true)
            {
                ...
                if (choice == "1")
                {
                    ...
                    else Console.WriteLine($"ID: {users[id].id}, логин: {users[id].login}, пароль: {users[id].password}, должность: {users[id].role}");
                ...
                else if (choice == "2")
                {
                    ...
                    foreach (User user in users)
                    {
                        if (id == user.id)
                        {
                            Console.WriteLine($"ID: {user.id}, логин: {user.login}, пароль: {user.password}, должность: {user.role}");
                        }
                    }
                }
                else if (choice == "3")
        ...
        public virtual void More()
        {
            while (true)
            {
                Console.WriteLine($"Введите индекс для подробной информации (Enter чтобы закончить):");
